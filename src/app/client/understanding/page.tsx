        ...
        <div className="page-container flex flex-col items-center">
          ...
          <div className="w-full max-w-[520px] card animate-fade-in-up delay-200">
            ...
            <div className="flex items-center gap-4 mb-stack-md">
              ...
              <span className="text-headline-md font-medium text-on-surface">Nous avons compris votre demande</span>
            </div>
            ...
            <div className="space-y-0 mb-stack-lg divide-y divide-surface-variant/30">
              <div className="flex justify-between items-center py-4">
                ...
                <span className="text-body-md font-medium text-on-surface">Création de logo</span>
              </div>
              <div className="flex justify-between items-center py-4">
                <span className="text-label-md text-on-surface-variant">Prix estimé</span>
                <div className="text-right">
                  ...
                  <p className="text-[10px] text-outline uppercase tracking-wider mt-1">
                    Basé sur les tarifs du marché local
                  </p>
                </div>
              </div>
              <div className="flex justify-between items-center py-4">
                <span className="text-label-md text-on-surface-variant">Délai de livraison</span>
                <span className="text-body-md font-medium text-on-surface">2 jours</span>
              </div>
              <div className="flex justify-between items-center py-4">
                <span className="text-label-md text-on-surface-variant">Catégorie</span>
                <span className="text-body-md font-medium text-on-surface">Branding & Identité</span>
              </div>
            </div>
            ...
            <p className="text-center mt-4 text-label-md text-outline">
              Vous pourrez affiner les détails à l&apos;étape suivante.
            </p>
          </div>
          ...
          <div className="mt-stack-lg w-full max-w-container grid grid-cols-1 md:grid-cols-2 gap-gutter opacity-80 animate-fade-in-up delay-300">
            {[
              { label: "Inspiration locale", bg: "from-amber-100 to-orange-50" },
              { label: "Savoir-faire", bg: "from-blue-50 to-indigo-50" },
            ].map((item) => (
